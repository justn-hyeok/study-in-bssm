...
class HomeHeaderForm extends StatelessWidget {
  HomeHeaderForm({Key? key}) : super(key: key);
      ...
      child: Align(
        ...
        child: Container(
          ...
          child: Form(
            key: _formKey,
            child: Padding(
              padding: const EdgeInsets.all(gap_l), // 4. 여기에느면되영 내부 여백
              child: Column(
                children: [
                  _buildFormTitle(), // 5. 여기에느면되영 위젯 제목 영역
                  _buildFormField(), // 6. 여기에느면되영 위젯 Text 입력 양식 영역
                  _buildFormSubmit(), // 7. 여기에느면되영 위젯 전송 버튼 영역
                ],
              ),
            ),
          ),
  ...
  Widget _buildFormSubmit() {
    return SizedBox(
      ...
      child: TextButton(
        ...
        onPressed: () {
          if (_formKey.currentState!.validate()) print("서브밋 클릭됨");
        },
        child: Text(
          "검색",
